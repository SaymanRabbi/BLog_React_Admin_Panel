                                    ...
                                    <div class="card card-animate">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="1975224">0</span>
                                                    </h4>
                                                    <a href="#" class="text-decoration-underline text-muted">24% higher yesterday   </a>
                                                </div>
                        ...
                        <div class="layout-rightside">
                            <div class="card h-100 rounded-0">
                                <div class="card-body p-0">
                                    ...
                                    <div data-simplebar style={{maxHeight: "410px"}} class="p-3 pt-0">
