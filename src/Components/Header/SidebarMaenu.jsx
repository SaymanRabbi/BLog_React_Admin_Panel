        ...
        <div class="app-menu navbar-menu">
            ...
            <div id="scrollbar" data-simplebar="init" class="h-100"><div class="simplebar-wrapper" style={{margin:" 0px"}}><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style={{right: "0px", bottom:" 0px"}}><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style={{height: "100%", overflow:" hidden scroll"}}><div class="simplebar-content" style={{padding: "0px"}}>
                <div class="container-fluid">
                       ...
                       <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="auth-signin-cover.html" class="nav-link" role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> Sign In   
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#postAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="postAuth">
                                <i class="lar la-user-circle"></i> <span data-key="t-authentication">Post</span>
                            </a>
                            <div class="collapse menu-dropdown" id="postAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="post.html" class="nav-link"> Post Table
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#categoryAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="categoryAuth">
                                <i class="lar la-user-circle"></i> <span data-key="t-authentication">Category</span>
                            </a>
                            <div class="collapse menu-dropdown" id="categoryAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="category.html" class="nav-link"> Category Table
                                        </a>
                                    </li>
                    ...
                    </div></div></div></div><div class="simplebar-placeholder" style={{width: "auto",height:" 296px"}}></div></div><div class="simplebar-track simplebar-horizontal" style={{visibility: "hidden"}}><div class="simplebar-scrollbar" style={{width: "0px",display: "none",transform: "translate3d(0px, 0px, 0px)"}}></div></div><div class="simplebar-track simplebar-vertical" style={{visibility: "hidden"}}><div class="simplebar-scrollbar" style={{height: "0px", display: "none"}}></div></div></ul>
                </div>
